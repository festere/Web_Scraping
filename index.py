...
label = Label(root, text="Type:")
label.pack()
type_value = Entry(root)
type_value.pack()

label = Label(root, text="Class:")
label.pack()
class_value = Entry(root)
class_value.pack()
...
def ExecuteCode():
    ...
    spans = soup.find_all(type_value.get(), {'class': class_value.get()})
